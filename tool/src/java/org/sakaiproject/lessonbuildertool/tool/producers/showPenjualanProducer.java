...
public class ShowProdukProducer implements ViewComponentProducer, NavigationCaseReporter, ViewParamsReporter {
	...
	public static final String VIEW_ID = "ShowPenjualan";
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
        ...
        UIOutput.make(tofill, "html").decorate(new UIFreeAttributeDecorator("lang", localeGetter.get().
        	...
        	listProduk = simplePageToolDao.getAllPenjualan();

			UIBranchContainer row_label = UIBranchContainer.make(tofill,"label-penjualan:");
            ...
            UIOutput.make(row_label,"label_user_id", "User ID");


         for (Penjualan item : listPenjualan){
            //Create a new <li> element
             UIBranchContainer row_isi = UIBranchContainer.make(tofill, "list-penjualan:");
             ...
             UIOutput.make(row_isi, "list_user_id", item.getUserID());
